package com.example.administrator.suvsproject.modules.MyLogin.dao.Person.Tiezi;
...
import com.example.administrator.suvsproject.modules.MyLogin.util.Person.Tiezi.MyTieziParse;
    ...
    public static void request(int page, String urlString , final BaseCallBack callBack){
        ...
        HttpUtil.doHttpReqeust1("POST", urlString, params, new BaseCallBack() {
            ...
            public void success(Object data) {
               if(callBack!=null){
                   List<TieziInfo> list= MyTieziParse.parseList(data.toString());

...
import com.example.administrator.suvsproject.modules.MyLogin.dao.Person.Collection.Newsdao;
...
public class CollectionFragment2 extends BaseFragment {
    ...
    private List<CollectionNewsInfo> datalist;
    private View footview;
    private CommonAdapter<CollectionNewsInfo> adapter;
    ...
    protected void init() {
        ...
        adapter = new CommonAdapter<CollectionNewsInfo>(getContext(),datalist,R.layout.collectionfragment_first_item) {
            @Override
            public void convert(ViewHolder helper, int position, CollectionNewsInfo item) {
    ...
    protected void requestNetData() {
        ...
        Newsdao.request(page, url ,new BaseCallBack() {
            @Override
            public void success(Object data) {
                swipeRefreshLayout.setRefreshing(false);
                final List<CollectionNewsInfo> list= (List<CollectionNewsInfo>) data;
                if(page==1){
                    datalist.clear();

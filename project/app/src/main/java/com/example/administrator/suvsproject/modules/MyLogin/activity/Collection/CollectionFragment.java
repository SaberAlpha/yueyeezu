...
import com.example.administrator.suvsproject.modules.MyLogin.dao.Person.Collection.MyCollectiondao;
...
public class CollectionFragment extends BaseFragment {
    ...
    private List<CollectiontieziInfo> datalist;
    private View footview;
    private CommonAdapter<CollectiontieziInfo> adapter;
    ...
    protected void init() {
        ...
        adapter = new CommonAdapter<CollectiontieziInfo>(getContext(),datalist,R.layout.collectionfragment_first_item) {
            @Override
            public void convert(ViewHolder helper, int position, CollectiontieziInfo item) {
    ...
    protected void requestNetData() {
        ...
        MyCollectiondao.request(page, url ,new BaseCallBack() {
            @Override
            public void success(Object data) {
                swipeRefreshLayout.setRefreshing(false);
                final List<CollectiontieziInfo> list= (List<CollectiontieziInfo>) data;
                if(page==1){
                    datalist.clear();

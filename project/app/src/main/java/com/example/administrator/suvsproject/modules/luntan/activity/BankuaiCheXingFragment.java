 ...
 */
public class BankuaiCheXingFragment extends BaseFragment implements AdapterView.OnItemClickListener {
    private static final String TAG = "BankuaiCheXingFragment";
    private ListView parentListView;
    private String categorytype = "chexing";
...
//                        }
                        ...
                        Log.e(TAG, "convert: "+sonJson );
                        if (sonJson.has("sub")){
                            addCb.setVisibility(View.VISIBLE);
                        }else {
                            addCb.setVisibility(View.GONE);
                        }
...
//            childListView.setVisibility(View.VISIBLE);
    ...
    @Subscribe
    public void getSonJson(JSONObject sonJson){

 ...
 */
public class ChekuPicsDetailsFragment extends Fragment {
    ...
    String url = "http://carport.fblife.com/carapi/getphotolist.php?pagesize=18&datatype=json&type=3&words=";
    int page = 1;
    String json;
